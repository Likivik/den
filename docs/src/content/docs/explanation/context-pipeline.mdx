...
[`nix/lib/ctx-apply.nix`](https://github.com/vic/den/blob/main/nix/lib/ctx-apply.nix) --
[`nix/lib/ctx-types.nix`](https://github.com/vic/den/blob/main/nix/lib/ctx-types.nix)
</Aside>
...
3. Deduplication
	...
	`assembleIncludes` in `nix/lib/ctx-apply.nix` ensures:
...
5. Output
	...
	`modules/outputs` collects all hosts and homes, calls `host.instantiate`
