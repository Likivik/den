...
[`modules/context`](https://github.com/vic/den/blob/main/modules/context)
</Aside>
...
The framework defines these contexts in `modules/context/` and the various battery modules.
